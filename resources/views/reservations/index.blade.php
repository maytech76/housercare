                            ...
                            <tbody>
                                @foreach ($reservations as $reservation)
                                    <tr>
                                        ...
                                        <td class="fw-light">{{ $reservation->user ? $reservation->user->name : 'Usuario no asignado' }}
                                            {{ $reservation->user ? $reservation->user->last_name : 'Usuario no asignado' }}
                                            {{ $reservation->user ? $reservation->user->name : 'Usuario no asignado' }}</td>
                        ...
                        <div class="m-2">
                            <form action="{{ route('reservations.store') }}" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-12 col-md-6">
                                        ...
                                        <select name="user_id" id="user_id" class="form-control" required>
                                            <option value="" selected disabled>Seleciona un Usuario</option>
                                ...
                                {{-- <td>
                                    ...
                                    @else
                                        <a href="{{ route('reservations.edit', $reservation->id) }}" class="btn btn-warning btn-sm">Registrar</a>
