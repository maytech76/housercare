            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h3 class="card-title">Eventos del Sistema</h3>
                        {{-- <button type="button" class="btn btn-success-gradient btn-w-xs mb-1"> + Usuario</button> --}}
                        <a class="btn ripple btn-teal"  data-bs-target="#select2modal" data-bs-toggle="modal" href="{{route('events.create')}} ">+ Nuevo</a>
                    </div>
                    <div class="card-body">
                            ...
                            <table class="table border-top-0  table-bordered text-nowrap border-bottom" id="responsive-datatable">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="wd-15p border-bottom-0 bg-light">Cliente</th>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="hidden" name="type" value="unico">
                                ...
                                <div class="col-12 col-md-6">
                                   ...
                                   {{--  hora fin --}}
                                    ...
                                    <div class="form-group mb-3">
                                        <label for="limit_guest">N° de Invitados</label>
                                        <input id="editLimite" type="text" id="limit_guest" name="limit_guest" class="form-control border border-secondary" placeholder="Ejemplo = 200">
                                        <small id="errorGuests" class="form-text text-danger" style="display: none;">Solo se permiten números</small>
                                    </div>
