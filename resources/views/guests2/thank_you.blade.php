<x-guest-layout>
        ...
        <img src="http://events.test/admin/img/brand/logo.png " class="main-logo" alt="logo">
        ...
        <div class="confirmation-wrapper">
            <div class="confirmation-box">
                ...
                <p>El equipo de Eventops, te damos la Bienvenida</p>
                ...
                <p><strong>Lugar:</strong> {{ $event->start_time }}</p>
                <p><strong>Lugar:</strong> {{ $event->address }}</p>
    
                <div class="alert alert-info" role="alert">
                    Si no recibiste el correo con tu código QR, revisa tu carpeta de <strong>spam</strong> o 
                    <a href="https://api.whatsapp.com/send?phone=56985017504&text=buenas,%20me%20interesa%20mas%20informaci%C3%B3n">contáctanos</a>.
                </div>
            </div>
            <a href="{{ url('/') }}" class="btn btn-primary mt-3">Eventops</a>
        </div>
