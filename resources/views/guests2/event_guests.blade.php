              ...
              <div class="card">
                <div class="card-body d-flex align-items-center justify-content-between">
                  <div>
                    ...
                    <p class="mb-0" id="fecha">Fecha: {{ $event->event_date}}</p>
                    <p class="mb-0">Total Invitados: {{ $event->guests_count }} / {{ $event->limit_guest }}</p>
                    <p class="mb-0 text-danger">Max Partners: {{ $event->limit_partners }}</p>
                  </div>
                  <div>
                    <a class="btn ripple btn-teal" data-bs-target="#select2modal" data-bs-toggle="modal" href="{{ route('guests2.create') }}">+ Nuevo</a>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="modal-content modal-content-demo">
                    ...
                    <div class="modal-body">
                        <div class="col col-lg-12">
                                ...
                                <div class="m-2">
                                    <form action="{{ route('guests2.store') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
...
@push('scripts')
    ...
    <script>
     ...
     {{-- Conversion de fecha a formato español --}}
    <script src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.29.1/moment.min.js"></script>
    <script>
       document.addEventListener('DOMContentLoaded', function() {
        const fechaElement = document.getElementById('fecha');
        const fechaText = fechaElement.textContent.replace('Fecha: ', '');
        
        // Formatear con moment.js
        const fechaFormateada = moment(fechaText).format('DD-MM-YYYY');
